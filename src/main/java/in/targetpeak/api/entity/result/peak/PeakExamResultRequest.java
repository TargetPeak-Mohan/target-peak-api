...
public class PeakExamResultRequest {
	...
	public PeakExamResultRequest() {
		super();
	}

	public PeakExamResultRequest(Integer attendantId, Integer attendantRoleId, Integer action, Integer examinationId,
	...
	public String toString() {
		return "PeakExamResultRequest [AttendantId=" + AttendantId + ", AttendantRoleId=" + AttendantRoleId
