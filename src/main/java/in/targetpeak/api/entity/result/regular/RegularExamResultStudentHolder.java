...
@Entity
public class RegularExamResultStudentHolder {
	...
	public RegularExamResultStudentHolder() {
		super();
	}
	...
	public String toString() {
		return "RegularExamResultStudentHolder [RollNo=" + RollNo + ", StudentName=" + StudentName + ", ExamName="
