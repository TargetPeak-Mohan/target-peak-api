...
public class RegularExamResultRequest {
	...
	public RegularExamResultRequest() {
		super();
	}

	public RegularExamResultRequest(Integer attendantId, Integer attendantRoleId, Integer action, Integer examinationId,
			Integer subjectId, Integer studentId, Integer organizationId, Integer instituteId, Integer classId,
			Integer divisionId, Integer recordStatus, Integer offset, Integer limit, String search, String syncDate) {
		super();
	...
	public String toString() {
		return "RegularExamResultRequest [AttendantId=" + AttendantId + ", AttendantRoleId=" + AttendantRoleId
