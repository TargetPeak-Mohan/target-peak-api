...
public class InversionCount {
	...
	/*
	 * This method sorts the input array and returns the number of inversions in the
	 * array
	 */
	...
	public static void main(String[] args) {
		...
		int arr1[] = new int[] {5,3,4,2,1};
		System.out.println("Number of inversions are " + mergeSort(arr1, 5));
